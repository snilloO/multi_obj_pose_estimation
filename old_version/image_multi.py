...
def get_add_objs(objname):
    ...
    if objname == 'ape':
        add_objs = ['can', 'cat', 'driller', 'duck', 'glue', 'holepuncher','eggbox'] # eggbox
    elif objname == 'benchvise':
        add_objs = ['ape', 'can', 'cat', 'driller', 'duck', 'glue', 'holepuncher','eggbox']
    elif objname == 'can':
        add_objs = ['ape', 'cat', 'driller', 'duck', 'glue', 'holepuncher','eggbox']
    elif objname == 'cat':
        add_objs = ['ape', 'can', 'driller', 'duck', 'glue', 'holepuncher','eggbox']
    elif objname == 'driller':
        add_objs = ['ape', 'can', 'cat', 'duck', 'glue', 'holepuncher','eggbox']
    elif objname == 'duck':
        add_objs = ['ape', 'can', 'cat', 'driller', 'glue', 'holepuncher','eggbox']
    elif objname == 'eggbox':
        add_objs = ['ape', 'can', 'cat', 'driller', 'duck', 'glue', 'holepuncher']
    elif objname == 'glue':
        add_objs = ['ape', 'can', 'cat', 'driller', 'duck', 'holepuncher','eggbox']
    elif objname == 'holepuncher':
        add_objs = ['ape', 'can', 'cat', 'driller', 'duck', 'glue','eggbox']
    return add_objs
